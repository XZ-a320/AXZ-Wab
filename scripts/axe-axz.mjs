...
const PAGES = [
  '/axz/', '/axz/guestbook/', '/axz/logbook/', '/axz/dispatch/', '/axz/sim/', '/axz/accessibility/', '/axz/aprilfools/',
  '/axz/en/', '/axz/en/guestbook/', '/axz/en/logbook/', '/axz/en/dispatch/', '/axz/en/sim/', '/axz/en/accessibility/', '/axz/en/aprilfools/',
]
